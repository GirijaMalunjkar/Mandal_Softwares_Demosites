  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>Hotel Royal Inn Family <br>Restaurant & Bar</h3>
              <p>
              Plot No, 10, Talegaon Dabhade Rd, Station, Anand Nagar, Rajgurav Colony, Talegaon Dabhade, Maharashtra 410506<br><br>
                <strong>Phone:</strong> +91 91300 40503<br>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://www.mandalsoftwares.com/">mandalsoftwares.com</a>
      </div>
    </div>
  </footer><!-- End Footer -->
